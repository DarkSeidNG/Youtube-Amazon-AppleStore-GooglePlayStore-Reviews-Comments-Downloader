				...
				<div class="col-sm-12 col-md-10 col-md-offset-1">
					<form id="download_form" class="download_form">
						...
						<div class="form-group">
							<button type="submit" class="btn btn-def btn-block"><img class="loader_image" height="17" src="images/icons/Preloader_3.gif"/> <span class="submit_text">Submit</span></button>
						</div>
					</form>
			...
			$.ajax({
				...
				success: function ( data ) {
					if ( data.type == 'success' ) {
						...
						$( '.action_button' ).show();
						$( '.action_button' ).attr( 'href', data.data );
					} 
